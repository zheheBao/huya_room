...
import { StyleSheet, Platform } from 'react-native'; // 品牌色
...
var variables = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, hyBrandColors), hyGrayColors), hyFillColors), hyFontSize), hySpacing), hyRadius), hyBorder), {}, {
  hyOpacity: hyOpacity,
  hyEnableAnimated: hyEnableAnimated
}, button), form), formItem), input), radio), checkbox), slider), topview), dropdown);
